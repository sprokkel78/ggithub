...
class BrowserWindow(Gtk.Application):
    def __init__(self):
        super().__init__(application_id="com.sprokkel78.ggithub")
    ...
    def do_activate(self):
        ...
        cache_dir = os.path.expanduser("~/.ggithub/cache")
        ...
        cookie_manager.set_persistent_storage(
            "/home/" + user + "/ggithub-cookies.db", WebKit2.CookiePersistentStorage.SQLITE
        )
